...
from .views import getData, changeStatusReservation, ReservationList, CreateReservation, UpdateReservation, CreatePayments, PaymentsList, Montos,ListCommercial
...
urlpatterns = [
    ...
    path('reservations/payments/list/<int:pk>', PaymentsList.as_view(), name='list_payments'),
    path('reservations/payments/add', CreatePayments.as_view(), name='add_payment'),
